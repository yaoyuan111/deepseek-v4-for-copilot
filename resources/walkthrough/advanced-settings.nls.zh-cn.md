...
- 超过 128 个已启用工具：不建议开启。因为 DeepSeek 单次 `tools` 请求最多支持 128 个 functions，超过这个数量后，Personal-AI 无法保证传给 DeepSeek 的 `tools` 列表稳定。请先关闭一些不常用的工具，再考虑开启。
...
[打开插件设置](command:workbench.action.openSettings?%5B%22%40id%3Apersonal-ai.experimental.stabilizeToolList%22%5D)
